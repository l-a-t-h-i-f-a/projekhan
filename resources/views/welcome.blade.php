...
<head>
  ...
  <title>Ponpes Ibnu Abbas As Salafy</title>
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="https://binabbas.org/" class="logo d-flex align-items-center me-auto">
        <img src="{{ asset('userpage/assets/img/logopondok.png') }}" alt=""> 
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#services">Materials</a></li>
          <li><a href="#contact">Contact</a></li>
        </ul>
        <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
      </nav>

      <a class="btn-getstarted" href="{{ route('login') }}">Mulai Belajar</a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <img src="{{asset('userpage/assets/img/hero-bg-abstract.jpg')}}" alt="" data-aos="fade-in" class="">

      <div class="container">
        <div class="row justify-content-center" data-aos="zoom-out">
          <div class="col-xl-7 col-lg-9 text-center">
            <h1>Materi Coding Pondok Pesantren Ibnu Abbas As Salafy</h1>
            <p>Website untuk pembelajaran materi coding santriwan santriwati pondok pesantren Ibnu Abbas As Salafy</p>
          </div>
        </div>
        <div class="text-center" data-aos="zoom-out" data-aos-delay="100">
          <a href="{{ route('login') }}" class="btn-get-started">Mulai Belajar</a>
        </div>
        </div>
      </div>
    ...
    <section id="services" class="services section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Materials</h2>
        <p>Materi-materi untuk pembelajaran coding santriwan santriwati pondok pesantren Ibnu Abbas As Salafy</p>
      </div><!-- End Section Title -->
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-about">
          <a href="https://binabbas.org/" class="logo d-flex align-items-center">
